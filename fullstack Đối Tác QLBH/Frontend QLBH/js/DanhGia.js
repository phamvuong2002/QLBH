...
function confirm(){
  if(good.length > 0){
    ...
    const url = `http://localhost:8080/api/addFeedback`;
    fetch(url, {
      method: 'POST',
      headers: {
...
function start(){
  ...
  if(good.length > 0) {
    ...
    option2.value = "0/5";
    option2.innerText = "0/5";
    option3.value = "1/5";
    option3.innerText = "1/5";
    option4.value = "2/5";
    option4.innerText = "2/5";
    option5.value = "3/5";
    option5.innerText = "3/5";
    option6.value = "4/5";
    option6.innerText = "4/5";
    option7.value = "5/5";
    option7.innerText = "5/5";
    feedback.append(option1, option2, option3, option4, option5, option6, option7)
